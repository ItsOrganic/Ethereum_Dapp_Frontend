...
const App = () => {
   ...
   */
  const contractAddress = "0xD1f378F267c20d7421b5A1064688F22457B5B6D0";
    ...
    <div className="mainContainer">
      <div className="dataContainer">
        <div className="header">
         ...
         <div className="bio">	
                    I am learning ethereum dapp developement so that's pretty cool right? Connect your Ethereum wallet and Vote me!	
        </div>	
